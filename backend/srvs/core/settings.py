...
SECRET_KEY = env.str(
    "SECRET_KEY",
    default="NLzN1V2y3NKf6kjt1NuV9dF0bI2e4d5j6i9p1yXsVFLmF4fErgsJ2",
)
...
ROOT_URLCONF = 'backend.srvs.core.urls'
...
WSGI_APPLICATION = 'backend.srvs.core.wsgi.application'
...
ACCOUNT = {
    ...
    "DAILY_INCREMENT_LIMIT": env.int("DAILY_INCREMENT_LIMIT", 100_000_000),
}

CORE_TYPE = env.str("CORE_TYPE", "private")
